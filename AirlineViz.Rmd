...
The first interesting pattern is that it appears that the data only show the first port visited rather than final destination, i.e. no locations in Europe but flights to major interchange hubs. The second is that it shows a few differences in the destinations with large changes. 
...
* [Airline Holiday Viz on GitHub](https://github.com/WillCHL/airlineViz)
